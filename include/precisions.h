...
class_precision_parameter(reionization_optical_depth_tol,double,1.0e-2) /**< Relative tolerance on finding the user-given optical depth of reionization given a certain redshift of reionization */
